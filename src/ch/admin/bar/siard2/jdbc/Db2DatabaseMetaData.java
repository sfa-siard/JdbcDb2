  ...
  implements DatabaseMetaData
{
    ...
    String tableNamePattern, String[] types) throws SQLException
  {
    ...
    sbSql.append("  TRIM(T.TABSCHEMA) AS TABLE_SCHEM,\r\n");
    sbSql.append("  TRIM(T.TABNAME) AS TABLE_NAME,\r\n");
    sbSql.append("  CASE TRIM(T.TYPE)\r\n");
    ...
    sbSql.append("  TRIM(T.REMARKS) AS REMARKS,\r\n");
    ...
    sbSql.append("  TRIM(V.TEXT) AS "+_sQUERY_TEXT+"\r\n");
